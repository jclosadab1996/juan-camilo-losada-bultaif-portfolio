...
export const ui = {
  es: {
    ...
    problemas. Apasionado por mantenerse actualizado en las últimas tendencias y técnicas de desarrollo frontend.`,
    'contact.paragraph.3': `Ansioso por contribuir a proyectos innovadores, a la vez que continúo expandiendo mis conocimientos y
    experiencia en el área de desarrollo frontend. Si tienes alguna pregunta o quieres contactar conmigo, no dudes en
    escribirme.`,
